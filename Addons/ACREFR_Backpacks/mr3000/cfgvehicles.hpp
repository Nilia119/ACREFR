class ACREFR_mr3000: ACREFR_Bag_Base {
    ...
    model = "ACREFR_Backpacks\models\ACREFR_clf_nicecomm2_prc117g";
    hiddenSelections[] = {"camo"};
    hiddenSelectionsTextures[] = {"ACREFR_Backpacks\models\data\ACREFR_clf_nicecomm2_csat_multi_co.paa"};
    maximumLoad = 240;
    mass = 20;
};
...
class ACREFR_mr3000_multicam: ACREFR_mr3000 {
    ...
    hiddenSelections[] = {"camo"};
    hiddenSelectionsTextures[] = {"ACREFR_Backpacks\models\data\ACREFR_clf_nicecomm2_co.paa"};
};
...
class ACREFR_mr3000_rhs: ACREFR_mr3000 {
    ...
    hiddenSelections[] = {"camo"};
    hiddenSelectionsTextures[] = {"ACREFR_Backpacks\models\data\ACREFR_clf_nicecomm2_rhs_digital_co.paa"};
};
